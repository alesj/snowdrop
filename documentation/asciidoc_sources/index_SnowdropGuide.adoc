...
Use one of the following spring version profiles: spring-2.5, spring-3, spring-3.1,
spring-3.2, spring-4.0, and spring-4.1 _(the default)_.
...
. Copy the contents of one of the `module-spring-2.5/`, `module-spring-3/`,
`module-spring-3.1/`, `module-spring-3.2/`, `module-spring-4.0/` or `module-spring-4.1/` directories to the
`$JBOSS_HOME/modules/system/add-ons/snowdrop` directory of your JBoss AS installation.
...
`*org.springframework.spring:snowdrop*`::
  ...
  from only one of the following Spring versions: 2.5, 3, 3.1, 3.2, 4.0 or 4.1. Users may add other JARs to the module as needed.
